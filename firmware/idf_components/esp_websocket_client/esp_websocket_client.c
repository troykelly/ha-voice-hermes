...
// ha-voice-hermes modification: fail the WebSocket handshake on HTTP 3xx.
// Upstream redirect handling reuses configured Authorization/X-Device-ID
// headers at the new URI, which violates the device credential origin fence.
